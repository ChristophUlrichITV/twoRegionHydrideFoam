...
Description
    Solves the transient absorption/desorption reaction process
    of hydrogen into/from a metal-hydride powder.
...
int main(int argc, char *argv[])
{
    ...
    while (runTime.loop())
    {
        ...
        // Transfer pressure and gas density mesh to mesh
        #include "pressureTransfer.H"
        #include "rhoGas_toMetal.H"
